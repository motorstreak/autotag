...
var AutotagJS=function(){function w(f,e){return"undefined"===typeof f||null==f?e:f}function J(f,e){return e.parentNode.insertBefore(f,e.nextSibling)}function P(f,e){f&&f.nodeType==Node.ELEMENT_NODE&&e&&e.length&&f.setAttribute("style",e)}function Z(f,e){for(var k=0,h;h=f[k];k++)e.appendChild(h)}function x(f,e){return f&&f.classList&&f.classList.contains(e)}function y(f,e){var k=document.createElement(f);e&&(k.className=e);return k}function z(f){return f&&f.parentNode.removeChild(f)}function aa(f,
...
0;d<b.length;d++){var l=b[d].split(/\s*:\s*/);g=l[0];var f=l[1];l=a.style;var e=l.getPropertyValue(g);if(0<e.length&&c.match(/^atg(Unset|Toggle)/))l.removeProperty(g);else if(c.match(/^atg(Set|Initialize|Toggle)/))l.setProperty(g,f);else if(c.match(/^atg(Increment|Decrement)/)){e=e||getComputedStyle(a).getPropertyValue(g);f=ha(f);e=ha(e);switch(c){case "atgIncrement":e+=f;break;case "atgDecrement":e-=f}0>=e?l.removeProperty(g):l.setProperty(g,e+"px")}}},S=function(a,c,b,d,g){b="hsla("+c+", "+b+"%, "+
d+"%, 1.0)";c=y("div","atg-palette-cell");c.style.background=b;c.dataset.atgPaletteColor=b;if("highlight"===g){g=c.dataset;b=c.style.background.match(/[.?\d]+/g);for(d=0;3>d;d++)b[d]/=255,b[d]=.03928>=b[d]?b[d]/12.92:Math.pow((b[d]+.055)/1.055,2.4);g.atgPaletteContrastColor=.179<.2126*b[0]+.7152*b[1]+.0722*b[2]?"#000":"#FFF"}return a.appendChild(c)},ia=function(a,c){var b=y("p","atg-line-body");b.setAttribute("contenteditable",!0);a.appendChild(b);c.addPilotNode&&T(b,c.setCaret)},B=function(a,c){c=
c||{};var b=y("p","atg-line");b.setAttribute("contenteditable",!0);b.dataset.atgIndentPos=0;if(a){switch(c.attachAs){case "child":a.appendChild(b);break;case "next-sibling":J(b,a);break;case "previous-sibling":a.parentNode.insertBefore(b,a);break;default:J(b,a)}"child"!==c.attachAs&&p(a)&&(b.dataset.atgIndentPos=a.dataset.atgIndentPos);ia(b,c)}return b},T=function(a,c){a=m(a)?t(a):a;ba(a);var b=v(U("\u200b\u200b")),d=b.parentNode;a.appendChild(d);d.classList.add("atg-bol");P(d,"");c&&n(b,2)},v=function(a,
c,b){if(u(a)){if(!a.parentNode||V(a))c=y("span",c),c.classList.add("atg-text"),P(c,b||""),a.parentNode&&a.parentNode.insertBefore(c,a),c.appendChild(a);return a}},U=function(a){a=a&&a.replace(/ /g,"\u00a0")||"";return document.createTextNode(a)},L=function(a){a=w(a,q());if(a.collapsed){var c=a.endContainer;a=a.endOffset;H(c.parentNode)&&2>a&&(a=2);n(c,a)}},W=function(){if(0==f.textContent.length)return B(f,{attachAs:"child",addPilotNode:!0,setCaret:!0})},ka=function(a,c){if(a){var b=q();switch(c){case "line":b=
...
c,function(b){if(a.intersectsNode)b=a.intersectsNode(b);else{var c=b.ownerDocument.createRange();try{c.selectNode(b)}catch(Ga){c.selectNodeContents(b)}b=-1==a.compareBoundaryPoints(Range.END_TO_START,c)&&1==a.compareBoundaryPoints(Range.START_TO_END,c)}return b})}},ma=function(a,c,b){return document.createTreeWalker(a,c,{acceptNode:function(a){return!b||b(a)?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_REJECT}},!1)},X=function(){for(var a=menubar.querySelectorAll(".atg-submenu"),c=0,b;b=a[c];c++)b.style.display=
"none"},m=function(a){return a&&a.nodeType==Node.ELEMENT_NODE&&x(a,"atg-line")},Y=function(a){return a&&a.nodeType==Node.ELEMENT_NODE&&x(a,"atg-line-body")},D=function(a){return a&&u(a)&&(Y(a.parentNode)||Y(a.parentNode.parentNode))},na=function(a){var c;if(c=D(a))c=(a=a.parentNode)&&x(a,"atg-text");return c},V=function(a){return D(a)&&Y(a.parentNode)},H=function(a){return a&&x(a,"atg-text")&&x(a,"atg-bol")},p=function(a){return m(a)&&"0"!==a.dataset.atgIndentPos},oa=function(a,c){for(var b=a,d=a;p(d.previousSibling);)d=
...
"\u25c6";break;case "white-diamond":h="\u25c7"}n.push(h)}e=n.join(q)+f}l.appendChild(U(e))}}while(p(a.nextSibling)&&(a=a.nextSibling))}b&&!p(b)&&(b=N(b))&&z(b)},O=function(a,c,b){if(D(a)){c%=2;if(0==c)return a;if(b=w(b,!0)){b=r(a);var d=C(b);a=d.indexOf(a);return 0===a&&-1===c?(c=b.previousElementSibling)&&C(c).pop():a===d.length-1&&1===c?(c=b.nextElementSibling)&&C(c).shift():d[a+c]}a=a.parentNode;return(c=1===c?a.nextSibling:a.previousSibling)&&c.firstChild}},qa=function(){var a=q().endContainer;
u(a)&&V(a)&&(E(a,0),n(a));pa(a)},pa=function(a){var c;var b=(c=a.textContent.match(/(^\u200b{2}(?=.))|(\w+(?=\W)|\W+(?=\w))/))?c[0].length:void 0;isNaN(b)||(a=E(a,b,!0).pop(),pa(a),n(a,1),L())},sa=function(a,c){var b=a.startContainer,d=a.startOffset;L(a);if(a.collapsed&&u(b)){var g=r(b);if(H(b))return B(g,{addPilotNode:!0,setCaret:!0});if(D(b)&&d==b.textContent.length&&!O(b,1,!1))b=B(g,{addPilotNode:!0,setCaret:!0});else if(ra(b,d))b=B(g,{attachAs:"previous-sibling",addPilotNode:!0,setCaret:!1});
else{d=E(b,d)[1];b=B(g,{addPilotNode:!0});var f=[],e=d.parentNode;do f.push(e);while(e=e.nextSibling);Z(f,t(b));n(d,0)}b.className=g.className;P(b,g.getAttribute("style"));p(b)&&c&&(b.dataset.atgListId="");if(p(g))var h=N(g).dataset.atgListType;oa(b,h)}},n=function(a,c){a&&!u(a)&&(a=C(a).pop());if(a)return c=w(c,a.length),M({startContainer:a,startOffset:c,endContainer:a,endOffset:c})},M=function(a){var c=a.startContainer,b=a.endContainer;if(c&&b){var d=w(a.startOffset,0),g=w(a.endOffset,b.length);
...
ua=function(a){return"0px"!==window.getComputedStyle(r(a),null).getPropertyValue("margin-left")},ra=function(a,c){a=0==c?O(a,-1,!1):a;return H(a.parentNode)},Ea=function(a){var c=a.previousElementSibling,b=t(a);if(m(c)){c=t(c);var d=c.lastChild;b=va(b);b.shift();Z(b,c);setTimeout(function(){z(a);n(d.firstChild);d.focus();d.click()},0)}else T(b,!0)},Fa=function(a){for(var c=ja(a),b=O(c[0],-1)||O(c[c.length-1],1),d=0,g;g=c[d];d++)na(g)&&(g=g.parentNode),z(g);b&&n(b);aa(I(a,NodeFilter.SHOW_ELEMENT,m),
function(a){var b;(b=a&&0==a.textContent.length)||(b=(a=t(a))&&0==a.textContent.length);return b});W()},E=function(a,c,b){c=w(c,0);var d=C(r(a)),g=d.indexOf(a);if(u(a))if(0==c){var f=v(d[g-1]);var e=v(a)}else c==a.length?(f=v(a),e=v(d[g+1])):(f=v(a),e=a.splitText(c),v(z(e),null,f.parentNode.getAttribute("style")),J(e.parentNode,f.parentNode));b&&za([f,e]);return[f,e]},ja=function(a){if(a.collapsed)var c=[a.startContainer];else{c=a.startContainer;var b=a.startOffset,d=a.endContainer;a=a.endOffset;
var f=E(c,b)[1],e;c.isSameNode(d)&&(a-=b,d=f,c.length==a&&(e=f));e||(e=E(d,a)[0]);c=M({startContainer:f,startOffset:0,endContainer:e,endOffset:a});c=I(c,NodeFilter.SHOW_TEXT,D)}for(b=0;a=c[b];b++)V(a)&&(d=a.nextSibling,e=a.parentNode,a=v(a),e.insertBefore(a,d));return c};f.addEventListener("dblclick",function(a){});f.addEventListener("click",function(a){X();W();L()});f.addEventListener("focus",function(a){});f.addEventListener("input",function(a){if("deleteContentBackward"==a.inputType||8==k){aa(f.querySelectorAll("br"));
var c=q(),b=c.endContainer,d=b.parentNode;var g=w(void 0,q());g=r(g.startContainer,!1);H(d)&&1==c.endOffset?(t(g).firstChild.firstChild.nodeValue="\u200b\u200b",n(d.firstChild),p(g)?A(g,h.CLEAR_LIST):ua(g)?G(g,h.DECREASE):Ea(g),a.preventDefault()):0==c.endOffset&&b&&x(b,"atg-text")?(n(b.previousSibling.firstChild),z(b)):(a=t(g),(c=t(a))&&2>=c.textContent.length?T(a):N(g)&&null==a?ia(g,{addPilotNode:!0}):W())}else qa()});f.addEventListener("keydown",function(a){k=a.which||a.keyCode||0;8!=k&&L();var c=
