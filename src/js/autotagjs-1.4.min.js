...
da(a,NodeFilter.SHOW_ELEMENT);return ba(c,t)}return w(a,t)},z=function(a){return A(a,NodeFilter.SHOW_ELEMENT,t)},da=function(a,b,c){return document.createTreeWalker(a,b,function(a){return!c||c(a)?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_REJECT},!1)},I=function(a,b,c){if(!ea(a)){c=p(c,!0);b=p(b,N(a));var d=ca(n);if(P(a)||!u(a.parentNode)&&a.classList.contains("atg-list"))Q(a,b,D(a),c);else{var e=a,g=l();e=p(e,g&&g.endContainer);C(e,!0);e=a.previousSibling;m(e)||(e=x(),a.parentNode.insertBefore(e,
a));E(e);e.appendChild(a);Q(a,b,D(a),c);b=w(a,m);for(c=0;c<b.length;c++)a.parentNode.insertBefore(b[c],a.nextSibling)}R(d)}},E=function(a){if(u(a.parentNode))return S(a,"atg-list"),!0;a.classList.remove("atg-list");return!1},T=function(a){if(a)return a=a.textContent,0==a.length||"\u200b"==a},F=function(a){return m(a)&&T(a)},P=function(a){return a.classList.contains("atg-list-blank")},u=function(a){return a&&a.isSameNode(f)},m=function(a){return a&&"DIV"==a.tagName&&!u(a)},ea=function(a){return!u(a.parentNode)&&
...
f.addEventListener("keydown",function(a){Z();var b=p(void 0,M());var c;if(m(b))for(c=1;b=b.previousSibling;)c++;var d=l(),e=a.which||a.keyCode||0;if(8==e||9==e){a:{c=a.shiftKey;if(d.collapsed){var g=d.startContainer;b=d.startOffset;d=M();if(ia(O(g),b)&&D(d)){9==e?c?J(d,!1):I(d,null,!1):8==e&&(P(d)?J(d,!1):S(d,"atg-list-blank"));break a}if(9==e){d=v(g)?g.parentNode:g;if(t(d)&&!c){g=d.textContent;c=d.parentNode;var f=d.nextSibling;e=y("    ");0===b?(c.insertBefore(e,d),k(d.firstChild,0)):b===
